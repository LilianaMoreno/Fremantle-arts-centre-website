        ...
        'link_class' => "nav-link",
          ...
          <div class="container">
              <div class="tag-grid">
                  ...
                  <h1 class="tag text-center"><?php the_field('tagline'); ?></h1>
                  <a href="<?php the_field('taglinebutton'); ?>" class="btn btn-default btn-lg explore-music-events-button">EXPLORE MUSIC EVENTS</a>  
              </div>
            </div>
      </section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-8">
             ...
             <div class="col-sm-4">
            <a href="<?php the_field('seeallbutton'); ?>" class="see-all-button">SEE ALL <span class="fas fa-angle-right"></span> </a>
       </div>
        </div>
    <div class="row">
    <div class="col-sm-4">
        ...
        <p class="Article-titles"><?php the_field('articlethreetitle'); ?></p>
         ...
         <a href="<?php the_field('readmorebutton'); ?>" class="read-more-button">READ MORE <span class="fas fa-angle-right arrow"></span> </a>
              <a href="<?php the_field('mobileseeallbutton'); ?>" class="btn btn-default btn-lg see-all-button-mobile">SEE ALL <span class="fas fa-angle-right arrow"></span> </a>  
        </div>
        </div>
                    </div>
      </section>
...
<div class="col-sm-6">
    <p class="market-body"><?php the_field('marketsdescription'); ?></p>
     <a class="btn btn-default btn-lg markets-button" href="<?php the_field('marketsbutton'); ?>">EXPLORE</a>
              </div>
              </div>
          </div>
                        </section>
...
<img class="about-rectangle img-responsive" width="400" src="<?php the_field('abouttitlegradient'); ?>">
                       ...
                       <p class="about-body"><?php the_field('aboutdescription'); ?></p>
                                                 <a href="<?php the_field('aboutbutton'); ?>" class="btn btn-default btn-lg about-button"> FIND OUT MORE</a>
                    </div>
                       <div class="col-sm-6">
